...
SCHEMA_VERSION = "programming_kg_schema_v3"
...
class RuleExtractor:
    ...
    def extract(self, chunk: dict[str, Any]) -> dict[str, Any]:
        ...
        for relation in self._extract_code_structure_relations(content):
            ...
            entities.append(self._entity(tail,…1288 tokens truncated… report = self._build_report(chunks, entity_list, relation_list)
